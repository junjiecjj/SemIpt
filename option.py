...
parser.add_argument('--load', type=str, default=home+'/IPT-Pretrain/results/xxx-xx-xx', help='file name to load')

parser.add_argument('--saveModel', type=str, default=home+'/IPT-Pretrain/ModelPt',  help='file name to save')  #cjj
parser.add_argument('--loadModel', type=str, default=home+'/IPT-Pretrain/ModelPt/xxx-xx-xx', help='file name to load')
